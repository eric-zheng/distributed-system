...
public class LogSetup {
	...
	/**
	 * Initializes the logging for the echo server. Logs are appended to the console
	 * output and written into a separated server log file at a given destination.
	 * 
