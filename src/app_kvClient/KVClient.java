...
//		client.addListener(this);
	...
	private void handleCommand(String cmdLine) {
		...
		/////////////////////////////////////////////////////////////////////////////
			...
			//expected grammar: SELECT <column names> FROM <table name> WHERE <filter string> TOBE <table name>
			int i=1;
			ArrayList<String> col=new ArrayList<String>();
	...
	/**
	 * subscribe a given key in the system
	 * notify the client if the value of the key is changed or the key is deleted
	...
	/**
	 * unsubscribe a given key
	 * the client will not receive new notifications regarding the key
	 * @param key
	 */
	...
	private void printHelp() {
		...
		sb.append(PROMPT).append("SELECT <columns> FROM <table name> WHERE <filter constrains> TOBE <new table name>");			// new command to add
