...
class DBCache{
	...
	/*for now we use a array for actual cache. maybe later we will change this for better performance*/
	...
	/**
	 * search through the cache and try to find a matching tuple with the specified key
	...
	/**
	 * insert a tuple into the cache. if the cache is full then eviction algorithm is used
